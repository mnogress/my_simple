...
#### はじめに
<p>
このページでは、産業中分類番号から産業大分類番号へ変換するための自作関数を紹介しています。
統計データや企業データを扱う際、産業分類コードを変換する作業は頻繁に発生しますが、Python 標準では変換表が提供されていないため、自分で対応する必要があります。
</p>

<p>
ここで紹介する関数は、実務でよくある「中分類でデータを受け取り、大分類で集計したい」といったケースに対応するために作成したものです。
シンプルで再利用しやすく、前処理の効率化に役立ちます。
</p>

<p>
産業分類を扱う場面は地味ながら多く、毎回手作業で変換するのは非効率です。
このページの関数を活用することで、分類変換を確実に行い、分析作業をスムーズに進めることができます。
</p>
