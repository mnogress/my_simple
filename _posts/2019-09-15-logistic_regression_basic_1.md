...
![df.shape]({{ "assets/img/2020_08_15/0924_r4.png" | relative_url}})　<br>

* Precision(適合率)　：　TP /　(TP + FP) 実際値において正解が占める割合
* Recall(再現率) : TP / (TP + FN) 予想値において正解が占める割合
...
モデルの性能を議論する純粋な数理系のディスカッションでも無い限り、f1 を指標として使う必要はないと個人的には考えます。
的中率を使うので事が足りると思います。

* Accuracy(正解率):TP+TN/(TP+FP)+(FN+TN)的中率ともいう
